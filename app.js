...
const App = (() => {
  ...
  function buildBloqueFields(num) {
    const containerId = `bloque${num}-fields`;
  ...
  function sortPorEstado(a, b) {
    ...
    const da  = ord[a._est.valor] ?? 2;
    const db  = ord[b._est.valor] ?? 2;
    return da !== db ? da - db : b._dias - a._dias;
  }
  ...
  function renderCard(p) {
    ...
    return `<div class="pedido-card ${estClase}">
